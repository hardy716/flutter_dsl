...
void main() {
  test('default scales follow the documented values', () {
    ...
    expect([t.space.xs, t.space.sm, t.space.md, t.space.lg, t.space.xl, t.space.xxl],
        [4, 8, 16, 24, 32, 48]);
    expect([t.radius.sm, t.radius.md, t.radius.lg, t.radius.pill],
        [4, 8, 16, 999]);
  });
  ...
  test('value equality drives updateShouldNotify correctness', () {
    ...
    expect(const DesignTokens(space: SpacingScale(md: 20)),
